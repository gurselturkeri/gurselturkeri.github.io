...
<section class="stack reveal d3" aria-labelledby="stack-heading">
  <h2 class="stack-heading" id="stack-heading">Tools &amp; Systems</h2>
  <div class="stack-grid">
    <div class="stack-group">
      <h3 class="stack-label">Languages</h3>
    ...
    <div class="stack-group">
      <h3 class="stack-label">Robotics &amp; Autonomy</h3>
      <ul class="stack-chips">
        <li>ROS2 / ROS</li>
        <li>Autoware</li>
        <li>MoveIt</li>
    ...
    <div class="stack-group">
      <h3 class="stack-label">Perception &amp; ML</h3>
      <ul class="stack-chips">
        <li>OpenCV</li>
        <li>YOLOv8</li>
        <li>TensorRT</li>
    ...
    <div class="stack-group">
      <h3 class="stack-label">Platforms &amp; Tooling</h3>
      <ul class="stack-chips">
        <li>Linux</li>
        <li>Docker</li>
        <li>Git</li>
...
<div class="framed-container reveal d5">
  <figure class="framed-item">
...
<div class="video-frame reveal d5">
